...
public final class FastAsyncWorldEdit implements IWorldEdit
{
	@Override
	...
	{
		//TODO
		final WorldEdit worldEdit = SkyblockWorldEdit.getWorldEditPlugin().getWorldEdit();
		...
		final EditSession editSession =  worldEdit.getEditSessionFactory().getEditSession(world, maxBlocks);
